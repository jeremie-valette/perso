...
console.log(array1 + '  ==> array1'); // 18.5,19.3,16.8 
console.log(array2 +'  ==> array2'); // 123,56,99
...
console.log(array1.length +'  ==> array1.length'); // 4
...
console.log(array1.at(2) + '  ==> array1.at(2)'); // 3
...
de l'opération.*/
console.log(array1.concat(array2) +'  ==> array1.concat(array2)'); // 1,2,3,4,10,11,12

/*La méthode entries() renvoie un nouvel objet de type Array Iterator qui contient le couple clé/valeur
pour chaque élément du tableau.*/
const iterator1 = array1.entries();
console.log(iterator1 + '  ==> iterator1') // [object Array Iterator]
console.log(iterator1.next().value +'  ==> iterator1.next().value'); // 0,1
console.log(iterator1.next().value + '  ==>  iterator1.next().value'); // 1,2

const iterator2 = array1.entries().next().value;
console.log(iterator2 + '  ==> iterator2'); // 0,1

for(const [index, element] of array1.entries()){
console.log(index, element + " for(const [index, element] of array1.entries()){console.log(index, element )};"
)}; // 0 1  1 2  2 3  3 4
...
console.log(array1.every(estEnDessousDuSeuil) + '  ==> array1.every(estEnDessousDuSeuil)'); // true
...
console.log(array1.fill(0, 2, 4) + '  ==> array1.fill(0, 2, 4)'); // [ 1, 2, 0, 0 ]
console.log(array1.fill(5, 1) + '  ==> array1.fill(5, 1)'); // [ 1, 5, 5, 5 ]
console.log(array1.fill(6) + '  ==> array1.fill(6)'); // [ 6, 6, 6, 6 ]
